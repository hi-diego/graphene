...
using GrapheneDevelopmentTemplate.Database;
...
// Add DBContext
builder.Services.AddDbContext<DevelopmentDatabaseContext>(
...
Graph.RegisterServices<DevelopmentDatabaseContext>(builder);
